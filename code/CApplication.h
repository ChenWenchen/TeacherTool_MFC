...
public:
	...
	{
		BOOL result;
		InvokeHelper(0xce7, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVDisplayNumberConversionWarning(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xce7, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CSVKeepColumnAsTextIfMultipleEntriesAreText()
	{
		BOOL result;
		InvokeHelper(0xce8, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVKeepColumnAsTextIfMultipleEntriesAreText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xce8, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
